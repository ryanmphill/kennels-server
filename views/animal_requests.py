...
def get_all_animals():
    ...
    with sqlite3.connect("./kennel.sqlite3") as conn:
        ...
        for row in dataset:
            ...
            # del animal.location_id
            # del animal.customer_id
            ###############################################################
...
def get_single_animal(id):
    ...
    with sqlite3.connect("./kennel.sqlite3") as conn:
        ...
        # animal.__dict__['locationId'] = animal.__dict__.pop('location_id')
        # animal.__dict__['customerId'] = animal.__dict__.pop('customer_id')
        ####################################################################
...
def update_animal(id, new_animal):
    """Make an update to the animal row"""
    with sqlite3.connect("./kennel.sqlite3") as conn:
        db_cursor = conn.cursor()
